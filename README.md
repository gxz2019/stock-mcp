...
A Model Context Protocol (MCP) server for stock and crypto market analysis. Supports US stocks, cryptocurrency, A-shares, and Hong Kong stocks.
...
| `get_kline` | K-line (OHLCV) data — supports daily / weekly / monthly |
